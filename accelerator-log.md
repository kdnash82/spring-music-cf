...
{
  "gitBranch" : "main",
  "gitRepository" : "https://github.com/kdnash82/spring-music-cf",
  "includeHasTests" : false,
  "liveUpdateIDESupport" : true,
  "projectName" : "spring-music-cf",
  "sourceRepositoryPrefix" : ".",
  "targetProject" : "spring-music-cf"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [my-project->spring-music-cf]
...
┃ ┃ ┃ ┃ ┃ Debug Adding symbol artifactId with value 'spring-music-cf'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://git.example.com/my-repo->https://github.com/k...(truncated)]
